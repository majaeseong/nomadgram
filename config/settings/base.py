...
THIRD_PARTY_APPS = [
    ...
    'corsheaders' #장고가 3000번으로 다이렉트로 가는 요청을 막아준다.
]
LOCAL_APPS = [
...
#JWT -> default : 모든 request 는 승인을 받아야한다. - for protect api
REST_FRAMEWORK = {
...
#get으로 데이터베이스의 모양을 바꿔서는 안되지만 편해서 쓴다?
#logout을 하게 되면 데이터베이스의 모양이 바뀜.
